...
/**
 * Barra inferior fixa, no lugar onde o polegar alcanca. `pb-safe` respeita a
 * area do indicador de home do iPhone — sem isso o ultimo item fica embaixo
 * da barra do sistema e vira quase intocavel.
 */
export function Nav() {
