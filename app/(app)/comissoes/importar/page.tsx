  ...
  return (
    <>
      <PageHeader
        ...
        action={
          <Link href="/comissoes" className="btn-ghost px-3 text-[13px]">
            Voltar
          </Link>
        }
      />
      ...
      <section className="mb-5">
        ...
        <div className="card flex flex-col gap-3">
          {hotmartOk ? (
            <p className="text-[13px] text-muted">
              {hotmart
                ...
                : 'Credenciais preenchidas. Nada importado ainda.'}
            </p>
          ) : (
            <p className="text-[13px] leading-snug text-amber-400">
              Falta o Client ID e o Client Secret da Hotmart. Pegue em
              developers.hotmart.com &gt; Credenciais e cole em Configuracoes &gt; Chaves.
            </p>
          )}
          ...
          <ActionButton action={importHotmartProductsAction}>
      ...
      <section className="mb-5">
        ...
        <div className="card flex flex-col gap-3">
          {amazonOk ? (
            ...
            <p className="text-[13px] leading-snug text-amber-400">
              Faltam Access Key, Secret Key e a tag de afiliado. Crie as chaves em
              afiliados.amazon.com.br &gt; Ferramentas &gt; API de Publicidade de Produtos.
            </p>
          )}
      ...
      <section className="mb-5">
        ...
        <div className="card flex flex-col gap-3">
          ...
          <a href="/api/comissoes/exportar?dias=365" className="btn-ghost" download>
            Baixar CSV (12 meses)
          </a>
          <a href="/api/comissoes/exportar?dias=3650" className="btn-ghost" download>
            Baixar CSV (tudo)
          </a>
        </div>
      </section>
